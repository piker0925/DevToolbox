<template>
  <div class="mx-auto max-w-2xl px-6 py-8">
    <h1 class="mb-1 text-xl font-semibold text-slate-800">건의하기</h1>
    <p class="mb-6 text-sm text-slate-400">추가됐으면 하는 도구나 기능, 불편한 점을 자유롭게 남겨주세요.</p>

    <div v-if="submitted" class="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm">
      <p class="text-sm text-slate-700">감사합니다! 소중한 의견 남겨주셔서 감사합니다.</p>
    ...
    <div v-else class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div class="mt-3 flex items-center justify-between">
        <p class="text-xs text-slate-400">익명 · 로그인 없이 제출</p>
