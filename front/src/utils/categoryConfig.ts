...
import {AlignLeft, Calculator, FileText, Gamepad2, Globe, Image, ShieldCheck, Terminal, Type, Wrench, Zap,} from 'lucide-vue-next'
...
export const CATEGORY_ORDER = [
    'PDF', '이미지', '생성기', '보안·암호화', '포맷터', '텍스트', '네트워크', 'DevOps', '생활', '게임',
]
